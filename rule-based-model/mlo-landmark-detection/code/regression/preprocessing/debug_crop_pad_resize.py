...
dicom_base_path = str(MLO_ROOT / 'data' / 'mlo')  # Raw DICOM images
processed_image_dir = str(MLO_ROOT / 'processed_data' / 'images')  # Preprocessed images
fig_save_path = str(MLO_ROOT / 'figures' / 'debug_preprocessing')  # Debug visualization output
transformation_details_path = str(MLO_ROOT / 'processed_data' / 'transformation_details.csv')  # Transformation metadata
...
unified_df = pd.read_csv(PROJECT_ROOT / 'labels' / 'mlo_labels.csv')  # Labels CSV file
